...
// pyramid 2
 ...
 // pyramind 3
 // bottom layer
 boxc1=new box(570,205,60,60)
  
 boxc2=new box(630,205,60,60)

 boxc3=new box(690,205,60,60)

 boxc4=new box(750,205,60,60)

 boxc5=new box(810,205,60,60)

 // second layer

 boxc6=new box(630,160,60,60)

 boxc7=new box(690,160,60,60)

 boxc8=new box(750,160,60,60)

 // top layer

 boxc9=new box(690,98,60,60)
